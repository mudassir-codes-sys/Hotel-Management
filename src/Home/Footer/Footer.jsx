        ...
        <>
            <div className='md:grid md:grid-cols-4 flex flex-col justify-center items-center ' >
                <div className='px-20 mt-18' >
                    ...
                    <p className='max-w-70 mt-4 text-sm text-gray-900' >Discover the world's most extraordinary places to stay, from boutique hotels to luxury villas and private islands.</p>
                ...
                <div className='mt-18' >
                    ...
                    <p className='max-w-60 mt-2' >Subscribe to our newsletter for inspiration and special offers.</p>
                    <div className='flex ' >
                        <input className='border-2 px-2 border-r-black border-gray-600 mt-4' type="text" placeholder='Your Email' />
